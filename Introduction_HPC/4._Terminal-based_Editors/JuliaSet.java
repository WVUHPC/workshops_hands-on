...
// To make this code multithreaded replace the for loops
// on x and y for the IntStream lines shown below
//
//IntStream.range(0, w).parallel().forEach(x -> {
//IntStream.range(0, h).parallel().forEach(y -> {
//
// Also notice a change in the closing brackets "}" into "});"
...
public class JuliaSet extends JPanel {
    ...
    void drawJuliaSet(Graphics2D g) {
        ...
        for (int x = 0; x < w; x++) {
            System.out.println("drawing column " + x);
            for (int y = 0; y < h; y++) {
        ...
        // NOTE: Replace these two brackets for }); if you are using IntStream
            }
        }
    ...
    public void paintComponent(Graphics gg) {
        ...
        System.out.println("The drawing took " + (endTime - startTime)/1000000 + " milliseconds");  
